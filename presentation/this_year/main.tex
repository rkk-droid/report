...
\begin{frame}
  ...
  \begin{columns}
    ...
    \small
    \textbf{11 пакетных областей API:}
    \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \textbf{Всё покрыто тестами}
    \end{itemize}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{tabular}{llr}
      ...
      \midrule
      dygformer\_small & Python & 1.0x \\
      dygformer\_small & cpp & 2.8x \\
      dygformer\_small & cuda & \textbf{64.2x} \\
      \midrule
      ...
      dygformer\_large & cpp & 1.8x \\
      dygformer\_large & cuda & \textbf{175.9x} \\
      \midrule
      real\_scale & Python & 1.0x \\
      real\_scale & cpp & 3.3x \\
      real\_scale & cuda & \textbf{48.5x} \\
      \bottomrule
    \end{tabular}
    \end{table}
...
\begin{frame}
  \frametitle{Бенчмарк TemporalGraphSampler: полная таблица}
  \begin{table}
  \footnotesize
